...
Um curso de dez aulas que sai de uma pasta vazia e chega a uma API que valida o que recebe,
não vaza informação interna, se documenta a partir do próprio código, se defende de quem
abusa dela e roda igual em qualquer computador — construída do jeito que se constrói software
de verdade, e não do jeito que cabe num tutorial de vinte minutos.
